...
try {
  components = {
    ...
    mytabs: function () {
      return __webpack_require__.e(/*! import() | components/mytabs/mytabs */ "components/mytabs/mytabs").then(__webpack_require__.bind(null, /*! @/components/mytabs/mytabs.vue */ 280))
    },
    myscroll: function () {
    ...
    myvipmenu: function () {
      return __webpack_require__.e(/*! import() | components/myvipmenu/myvipmenu */ "components/myvipmenu/myvipmenu").then(__webpack_require__.bind(null, /*! @/components/myvipmenu/myvipmenu.vue */ 294))
    },
    mycard: function () {
...
var _default = {
  ...
  onLoad: function onLoad() {
    ...
    if (_logintools.default.islogin()) {
      //获取VIP最新推荐
      this.$service.vipService.getRecommendMenuList().then(function (res) {
      ...
      //获取限时免费菜单
      this.$service.vipService.getisFreeMenuList().then(function (res) {
      ...
      //猜你喜欢
      this.$service.vipService.likeMenu().then(function (res) {
